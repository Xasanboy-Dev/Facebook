        ...
        return (
            <div className="w-full rounded-[25px]" >
                <div className="text justify-between flex  text-dark bold">
                    <div className="w-[75px] h-[75px] justify-content-center flex rounded-full">
                        <div className="">
                ...
                <div className="text w-full flex items-center m-2 ">
                    <div className="w-[80%]">
                        <textarea className="border border-dark w-[80%] rounded-[10px]" placeholder="Write here somthing!" />
                        <div className="flex justify-content-center gap-5">
                            <ul className="flex gap-[15px] ml-[5%]">
                                <li className="cursor-pointer">
                                    <h4 className="flex gap-2  p-2 justify-content-center items-center">
                                ...
                                <li className="cursor-pointer">
                                    <h4 className="flex gap-2  p-2 justify-content-center items-center text-bold">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
