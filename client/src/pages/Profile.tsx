    ...
    return (
        <div>
            <div className="img flex items-end justify-content-between  m-2 rounded-xl">
                    ...
                    <li className="p-2">
                        <div className="flex items-end">
                            <div className="flex FIRST bg-red-500 flex justify-content-center items-end rounded-full image border cursor-pointer">
                                {avatar ? (
                                    <img className="logo rounded-full h-full w-full" src={`${avatar}`} />
                                ) : (
                                    <img
                                        src={`${logo}`}
                ...
                <div className="">
                    <form method="POST" action="http://localhost:8080/profile/dashboard/image">
            ...
            <div>
                <div className="border mx-5 rounded-full">
